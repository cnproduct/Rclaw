...
function getLogFilePath(): string {
  ...
  // Dev mode uses "Rclaw-Dev", production uses "Rclaw"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'Rclaw-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'Rclaw', `${today}.log`);
