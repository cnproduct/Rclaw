<p align="center">
  <img src="./resources/rclaw-banner-1.png" alt="Rclaw - Cowork with AI Agents" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/Rclaw?style=flat-square&color=32CD32" alt="Version">
  &nbsp;
...
<p align="center">
  <a href="https://github.com/iOfficeAI/Rclaw/releases">
...
[Why Choose Rclaw?](#-why-choose-rclaw-over-claude-cowork) ·
...
**Rclaw is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **Rclaw (Cowork)**                                                                                                           |
| :------------------------------ | :-------------------------- | :---------------------------------------------------------------------------------------------------------------------------- |
...
<p align="center">
  <img src="./resources/offica-ai BANNER-function.png" alt="Rclaw Cowork Platform" width="800">
</p>
...
Rclaw ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **Rclaw works the moment you install it**.
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, Rclaw auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, the Rust-based backend service bundled with Rclaw) • Snow CLI • Kiro • Hermes Agent • Cursor Agent and more
...
<p align="center">
  <img src="./resources/Rclaw_team.gif" alt="Team Mode overview" width="800">
</p>

- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model via ACP (Agent Communication Protocol, Rclaw's multi-agent coordination layer), Gemini, or Aionrs
...
Other AI apps give you a chatbox with your API key. **Rclaw gives you a full Cowork agent.**
...
Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. Rclaw supports **20+ AI platforms** including cloud services and local deployments.
...
Rclaw also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with Rclaw), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
Rclaw supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
Rclaw includes **20 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with Rclaw), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access Rclaw from any device, anywhere._
...
> **Setup:** Rclaw Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/iOfficeAI/Rclaw/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — Rclaw automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
<p align="center">
  <img src="./resources/rclaw sort file 2.gif" alt="Smart File Management" width="800">
</p>
...
> [Image generation model configuration guide](https://github.com/iOfficeAI/Rclaw/wiki/Rclaw-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose Rclaw Over Claude Cowork?
...
Rclaw is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, Rclaw is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | Rclaw                                                            |
| :------------ | :------------ | :---------------------------------------------------------------- |
...
A: <strong>No.</strong> Rclaw has a built-in AI agent that works immediately after installation. Just sign in with Google or enter any API key. If you also have CLI tools like Claude Code or Gemini CLI installed, Rclaw will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with Rclaw?</strong></summary>
A: Rclaw is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: Rclaw is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run Rclaw on a server (headless)?</strong></summary>
A: Yes — Rclaw WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about Rclaw?** [Let us know on X](https://x.com/Rclaw) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/iOfficeAI/Rclaw/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/iOfficeAI/Rclaw/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/iOfficeAI/Rclaw/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/iOfficeAI/Rclaw/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/iOfficeAI/Rclaw/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/iOfficeAI/Rclaw/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/iOfficeAI/Rclaw/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/iOfficeAI/Rclaw/wiki/Rclaw-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/iOfficeAI/Rclaw/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/iOfficeAI/Rclaw/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/iOfficeAI/Rclaw/wiki/Configuration-Guides) — Complete configuration documentation
...
<p align="center">
  <a href="https://x.com/Rclaw" target="_blank">
    <img src="./resources/contactus-x.png" alt="Contact Us on X" width="600">
  </a>
</p>

- [GitHub Discussions](https://github.com/iOfficeAI/Rclaw/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/iOfficeAI/Rclaw/issues) — bugs and feature requests
- [Release Updates](https://github.com/iOfficeAI/Rclaw/releases) — get the latest version
...
<p align="center">
  <a href="https://github.com/iOfficeAI/Rclaw/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=iOfficeAI/Rclaw&max=100" alt="Contributors" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.star-history.com/#iOfficeAI/rclaw&Date" target="_blank">
    <img src="https://api.star-history.com/svg?repos=iOfficeAI/rclaw&type=Date" alt="Star History" width="600">
  </a>
</p>
...
[Report Bug](https://github.com/iOfficeAI/Rclaw/issues) · [Request Feature](https://github.com/iOfficeAI/Rclaw/issues)
