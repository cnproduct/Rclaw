...
export interface IStartOnBootStatus {
  ...
  supported: boolean;
  /** Whether Rclaw is currently configured to launch at login */
  enabled: boolean;
...
export const fs = {
  ...
  // Skills Market: inject/remove the rclaw-skills builtin skill
...
export const deepLink = {
  /** Emitted when app is opened via rclaw:// protocol URL */
