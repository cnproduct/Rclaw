export const WORKSPACE_TOGGLE_EVENT = 'rclaw-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'rclaw-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'rclaw-workspace-has-files';
