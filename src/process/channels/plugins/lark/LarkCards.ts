...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: 'Rclaw Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        tag: 'markdown',
        content: [
          'Please pair your account with Rclaw:',
          '',
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          '1. Open Rclaw settings',
    ...
    elements: [
      {
        ...
        content: [
          ...
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          'Please approve in Rclaw settings:',
          '1. Open Rclaw app',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ Rclaw Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with Rclaw via Lark.',
          '',
          '**Common Actions:**',
    ...
    elements: [
      {
        ...
        content: [
          ...
          '3. Approve pairing in Rclaw settings',
    ...
    elements: [
      {
        tag: 'markdown',
        content: [
          'Channel settings need to be configured in the Rclaw app.',
          '',
          'Open Rclaw → WebUI → Channels',
        ].join('\n'),
      },
      {
        tag: 'action',
