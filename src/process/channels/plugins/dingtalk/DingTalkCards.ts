...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'Rclaw Assistant',
    text: '### Rclaw Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingHelpCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '',
      '**What is pairing?**',
      'Pairing links your DingTalk account with the local Rclaw application.',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'Rclaw Assistant Help',
    text: [
      '### Rclaw Assistant Help',
      '',
      'A remote assistant to interact with Rclaw via DingTalk.',
      '',
      '**Common Actions:**',
