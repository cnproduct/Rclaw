...
export const PROTOCOL_SCHEME = 'rclaw';

/**
 * Parse an rclaw:// URL into action and params.
 * Supports two formats:
 *   1. rclaw://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. rclaw://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
