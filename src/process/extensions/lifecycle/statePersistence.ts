...
const EXTENSION_STATES_FILE_ENV = 'RCLAW_EXTENSION_STATES_FILE';
 ...
 * Stored under getDataPath(): ~/.rclaw/extension-states.json (Electron release),
 * ~/.rclaw-dev/extension-states.json (Electron macOS dev), or the platform-standard
 * app data dir on Windows/Linux. Can be overridden via RCLAW_EXTENSION_STATES_FILE.
 */
