...
export const BUILTIN_IMAGE_GEN_NAME = 'rclaw-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['Rclaw Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
