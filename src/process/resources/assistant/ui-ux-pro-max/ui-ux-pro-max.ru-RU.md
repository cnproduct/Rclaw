...
База данных дизайна интегрирована в проект Rclaw по адресу `assistant/ui-ux-pro-max/data/`. Используйте скрипт поиска для нахождения релевантной дизайн-информации:
