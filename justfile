...
preflight:
    ...
    $failed = $false; \
    Write-Host "=========================================="; \
    Write-Host "  Rclaw Build Preflight Check"; \
    Write-Host "=========================================="; \
    Write-Host ""; \
...
info:
    Write-Host "Rclaw Build Environment"; \
    Write-Host "========================"; \
...
build-win: preflight
    ...
    Get-Process -Name "Rclaw","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue; \
