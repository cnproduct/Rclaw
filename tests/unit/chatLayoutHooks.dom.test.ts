...
vi.mock('@/renderer/utils/workspace/workspaceEvents', () => ({
  WORKSPACE_TOGGLE_EVENT: 'rclaw-workspace-toggle',
  WORKSPACE_STATE_EVENT: 'rclaw-workspace-state',
  WORKSPACE_HAS_FILES_EVENT: 'rclaw-workspace-has-files',
...
describe('useWorkspaceCollapse', () => {
  const STORAGE_KEY = 'rclaw_workspace_panel_collapsed';
